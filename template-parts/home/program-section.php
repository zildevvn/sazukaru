<?php
$program_link_1 = home_url('/program1/');
$program_link_2 = home_url('/program2/');
$programs = [
    [
        'title' => '代理出産プログラム',
        'desc' => '「厳格な審査をクリアした代理母と、 専門家チームによる確かな支え」',
        'content' => ' 
            <p>代理出産において最も大切なのは、代理母の心身の健康と、法的な安全性が守られていることです。当社では、出産経験があり、家族の協力が得られている健康な代理母のみを厳選。</p>
            <p>医師・弁護士と連携した多職種サポート体制で、受精卵の移植から出産まで、すべての工程を慎重に進めていきます。</p>
        ',
    ...
    [
        ...
        'content' => '
            <p>先天的な要因や病気の影響で自力の排卵が難しい方へ。当社では、日本人ドナーを含む多様なバックグラウンドを持つドナーのご紹介が可能です。</p>
