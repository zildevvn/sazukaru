...
<?php if (!empty($search_query)): ?>
	<div class="sazukaru-results-search-section">
		<div class="container">
			<?php if (have_posts()): ?>
				<?php
				global $wp_query;
				...
				echo '<h4 class="sazukaru-results-search-section__total ">';
				...
				<div class="sazukaru-results-search-section__list d-flex flex-wrap">
				...
				?>
			<?php else: ?>
				<h3 class="sazukaru-results-search-section__total" style="text-align: center;">No results found</h3>
			<?php endif; ?>
		</div>
	</div>
<?php endif; ?>
